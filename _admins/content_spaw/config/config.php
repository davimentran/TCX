...
//SpawConfig::setStaticConfigItem('SPAW_DIR', '/_admins/content_spaw/');
...
if (isset($_SESSION['base_url_spaw_dir'])){
 ...
 SpawConfig::setStaticConfigItem('SPAW_PASS', $_SESSION['check_session_id'] );
...
// width
SpawConfig::setStaticConfigItem('default_width','99%');
// height 
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'../../products/flash/',
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'../../products/',
      'caption' => 'Products',
      'params'  => array(
	...
	array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'../../Asset/',
      'caption' => 'Asset',
      'params'  => array(
        'default_dir' => true, // set directory as default (optional setting)
        'allowed_filetypes' => array('any')
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'../../products/files/',
      'fsdir'   => SpawConfig::getStaticConfigValue('SPAW_ROOT').'../../products/files/', // optional absolute physical filesystem path
      'caption' => 'Files',
      'params'  => array(
        'allowed_filetypes' => array('any')
      )
