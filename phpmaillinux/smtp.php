...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname)
{
      ...
      $smtp_host ='mail.phuoclaptek.com';//Dia chi mail server
      $admin_email = 'noprely@phuoclaptek.com';//User duoc khai bao tren mail server
      $smtp_username = 'noprely@phuoclaptek.com';//User duoc khai bao tren mail server
      $smtp_password = '1234567890';//Pass cua email nay
